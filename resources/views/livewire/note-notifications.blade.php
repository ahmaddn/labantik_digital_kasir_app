<div class="relative" wire:poll.5s id="global-notifications-container" x-data="{ open: false }" @click.outside="open = false" @keydown.window.escape="open = false">
    ...
    <div x-show="open" x-cloak class="absolute right-0 top-full mt-2 w-80 sm:w-96 bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 z-[500] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
