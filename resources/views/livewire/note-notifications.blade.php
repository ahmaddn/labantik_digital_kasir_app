<div class="relative" wire:poll.5s id="global-notifications-container" x-data="{ open: false }" @click.outside="open = false" @keydown.window.escape="open = false">
    ...
    <div x-show="open" x-cloak class="fixed sm:absolute top-20 sm:top-auto right-4 sm:right-0 left-auto mt-3 w-auto sm:w-96 bg-white dark:bg-gray-800 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
