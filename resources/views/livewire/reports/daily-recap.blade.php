<div class="p-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6">
        ...
        <div class="flex flex-wrap items-center gap-4">
            <div wire:ignore x-data="{ value: @entangle('selectedDate').live, instance: null }" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-12">
        ...
        <div class="bg-primary-blue rounded-[3rem] p-10 text-white shadow-2xl shadow-blue-900/30 relative overflow-hidden group">
            ...
            <p class="text-4xl font-black text-white" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($recap->total_revenue_real, 0, ',', '.') }}</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-[3rem] p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 relative overflow-hidden group">
            ...
            <p class="text-4xl font-black text-primary-red" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($recap->total_profit, 0, ',', '.') }}</p>
            ...
            <div class="mt-8 flex flex-col gap-3">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs font-black" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($recap->total_revenue_real, 0, ',', '.') }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        >
            ...
            <div class="p-10 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-800 flex justify-between items-center">
                ...
                <div class="text-right">
                    ...
                    <p class="text-4xl font-black text-primary-blue tracking-tighter">Rp{{ number_format($this->detailItems->sum('total_price'), 0, ',', '.') }}</p>
                </div>
            </div>
        </div>
    </div>
