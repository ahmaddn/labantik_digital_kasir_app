<div class="p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <div class="bg-primary-blue rounded-[3.5rem] p-12 text-white shadow-2xl shadow-blue-900/30 relative overflow-hidden group">
            ...
            <h3 class="text-xs font-black uppercase tracking-[0.4em] opacity-60 mb-4">Total Pendapatan Tahunan</h3>
            ...
            <div class="mt-12 flex gap-10">
                <div>
                    <p class="text-[10px] font-black uppercase tracking-widest opacity-40 mb-1">Gross Omzet</p>
                    <p class="text-xl font-black italic">Rp{{ number_format($recap->total_revenue_all, 0, ',', '.') }}</p>
                </div>
                <div>
                    <p class="text-[10px] font-black uppercase tracking-widest opacity-40 mb-1">Total Sales</p>
                    <p class="text-xl font-black italic">{{ $recap->total_transactions }} Transaksi</p>
                </div>
            </div>
        </div>
