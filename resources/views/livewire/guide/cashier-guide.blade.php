<div class="py-6 w-full">
    ...
    <div
        ...
        <button wire:click="selectTab('leaderboard')"
            ...
            <svg class="w-4 h-4 mr-2 text-amber-500" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2
                            class="text-2xl font-black text-gray-950 dark:text-white uppercase italic tracking-tighter">
                            Papan Peringkat Kasir Aktif</h2>
                        <p class="text-sm text-gray-400 mt-1 uppercase tracking-wider font-bold">Bulan ini. Lakukan
                            performa terbaik untuk memimpin papan skor!</p>
                    </div>
                </div>
                ...
                @if (auth()->user()->points + auth()->user()->pending_points > 50)
                    <div
                        class="bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border border-amber-500/20 p-6 rounded-3xl flex items-center justify-between gap-4 animate-bounce mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h4
                                    class="font-black text-amber-600 dark:text-amber-400 uppercase tracking-wider text-xs">
                                    Kerja Bagus, {{ auth()->user()->name }}!</h4>
                                <p class="text-[10px] text-gray-500 dark:text-gray-400 font-semibold mt-0.5">Skor Anda
                                    telah melampaui 50 Pts. Terus pertahaman performa kerja beruntun Anda!</p>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                @endphp
                <div
                    class="grid grid-cols-3 gap-4 items-end justify-center pt-8 pb-10 border-b border-gray-150 dark:border-gray-800">
                    <!-- Rank 2 -->
                    @if ($top3->count() > 1)
                        @php $u2 = $top3->values()->get(1); @endphp
                        <div class="flex flex-col items-center">
                            <div
                                class="w-14 h-14 bg-gray-200 dark:bg-gray-800 border-2 border-gray-300 dark:border-gray-700 rounded-full flex items-center justify-center font-black text-gray-700 dark:text-gray-300 uppercase text-xs">
                                {{ substr($u2->name, 0, 2) }}
                            </div>
                            ...
                            <div
                                class="w-full h-16 bg-gray-100 dark:bg-gray-800 rounded-t-xl mt-3 flex items-center justify-center font-black text-gray-500 dark:text-gray-400 text-lg">
                                2
                            </div>
                        </div>
                    @endif
                    ...
                    @if ($top3->count() > 0)
                        ...
                        <div class="flex flex-col items-center">
                            <div class="relative">
                                <!-- Crown SVG -->
                                <svg class="w-6 h-6 text-amber-500 absolute -top-5 left-1/2 transform -translate-x-1/2 animate-bounce"
                                    fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                </svg>
                                <div
                                    class="w-18 h-18 bg-amber-500/20 border-4 border-amber-500 rounded-full flex items-center justify-center font-black text-amber-600 dark:text-amber-400 uppercase text-sm">
                                    {{ substr($u1->name, 0, 2) }}
                                </div>
                            </div>
                            <div class="text-center mt-2 min-w-0 w-full">
                            ...
                            <div
                                class="w-full h-24 bg-amber-500/10 dark:bg-amber-500/20 border-t-2 border-amber-500 rounded-t-xl mt-3 flex items-center justify-center font-black text-amber-600 dark:text-amber-400 text-2xl">
                                1
                            </div>
                        </div>
                    @endif
                    ...
                    @if ($top3->count() > 2)
                        ...
                        <div class="flex flex-col items-center">
                            <div
                                class="w-12 h-12 bg-amber-900/10 dark:bg-amber-955/20 border-2 border-amber-800/30 rounded-full flex items-center justify-center font-black text-amber-800 dark:text-amber-600 uppercase text-[10px]">
                                {{ substr($u3->name, 0, 2) }}
                            </div>
                            <div class="text-center mt-2 min-w-0 w-full">
                                <p class="text-xs font-black text-gray-800 dark:text-white truncate">
                            ...
                            <div
                                class="w-full h-12 bg-gray-50 dark:bg-gray-900 rounded-t-xl mt-3 flex items-center justify-center font-black text-gray-455 text-base">
                                3
                            </div>
                        </div>
                    @endif
                ...
                <div class="overflow-x-auto w-full rounded-2xl border border-gray-100 dark:border-gray-800">
                    <table class="w-full text-left min-w-[500px] md:min-w-0">
                        <thead class="bg-gray-50 dark:bg-gray-900/50">
                            <tr>
                                <th
                                    class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center w-16">
                                    Peringkat</th>
                                <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest">
                                    Kasir</th>
                                <th
                                    class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest text-center w-24">
                                    Streak</th>
                                <th
                                    class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest text-right w-32">
                                    Total Poin</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-50 dark:divide-gray-800/50">
                            @foreach ($leaderboard as $index => $u)
                                <tr
                                    class="hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors {{ $u->id === auth()->id() ? 'bg-primary-blue/5 dark:bg-primary-blue/10 font-bold' : '' }}">
                                    <td
                                        class="px-6 py-4 text-center text-xs font-black text-gray-500 dark:text-gray-400">
                                        {{ $index + 1 }}
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-7 h-7 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-[10px] font-black uppercase text-primary-blue border border-gray-200 dark:border-gray-700">
                                                {{ substr($u->name, 0, 2) }}
                                            </div>
                                            <span
                                                class="text-xs text-gray-800 dark:text-gray-200">{{ $u->name }}</span>
                                            @if ($u->id === auth()->id())
                                                <span
                                                    class="px-1.5 py-0.5 bg-primary-blue text-white rounded text-[8px] font-black uppercase tracking-wider">Anda</span>
                                            @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 text-center">
                                        <span
                                            class="inline-flex items-center gap-1 text-xs font-black text-orange-500">
                                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd"
                                                    d="M12.395 2.553a1 1 0 00-1.45-.385c-.345.23-.614.558-.822.94-.209.381-.363.887-.453 1.488-.12.802-.073 1.84.195 2.87l.062.24c.024.1.039.223.05.375a2.037 2.037 0 01-.029.511c-.048.24-.154.48-.32.647a.997.997 0 01-1.08.16c-.461-.247-.744-.623-.926-1.08-.182-.456-.224-.959-.224-1.347V6a1 1 0 00-1-1 3 3 0 00-2 2.22c0 1.258.18 2.5.474 3.738.152.64.4 1.25.753 1.807.353.558.836 1.057 1.443 1.487a8.007 8.007 0 005.19 2.09c.477.027.947-.033 1.4-.18a7.995 7.995 0 003.86-2.482c.187-.228.34-.483.47-.752.43-.892.652-1.928.652-3.141 0-1.622-.515-2.91-1.293-3.812a6.002 6.002 0 00-.825-1.012l-.011-.011-.002-.002a1 1 0 00-1.436.17l-.02.027a4.01 4.01 0 01-.262.33c-.758.874-1.808 1.47-3.2 1.47V2.553z"
                                                    clip-rule="evenodd" />
                                            </svg>
                                            {{ $u->streak }}
                                        </span>
                ...
                <!-- Points Rule Guide -->
                <div
                    class="p-6 bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800 w-full">
                    <h4 class="text-xs font-black text-gray-800 dark:text-white uppercase tracking-widest mb-3">Aturan
                        Perolehan Skor & Poin</h4>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div
                            class="p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Selesaikan checkout keranjang
                                    belanja di POS: <strong>+5 Poin & +1 Streak</strong></p>
                            </div>
                        </div>
                        <div
                            class="p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Centang/Toggle tugas harian
                                    kasir: <strong>+10 Poin & +1 Streak</strong></p>
                            </div>
                        </div>
                        <div
                            class="p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Input stok pembuka/penutup dan
                                    catat laci uang: <strong>+15 Poin</strong> (Streak kembali ke 0)</p>
                            </div>
                        </div>
                    </div>
                </div>
