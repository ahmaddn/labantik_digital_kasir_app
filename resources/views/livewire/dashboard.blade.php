<div class="p-4 md:p-6">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 md:mb-12">
        ...
        <div class="flex flex-wrap items-center gap-4">
            ...
            <div class="flex items-center bg-white dark:bg-gray-800 px-4 md:px-6 py-3 md:py-4 rounded-2xl shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-800">
    ...
    <div class="mb-8 md:mb-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <div class="bg-primary-blue rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-2xl shadow-blue-900/30 border border-transparent hover:scale-105 transition-all group overflow-hidden relative">
                ...
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <div class="p-4 md:p-5 bg-white/10 rounded-2xl text-white">
                        <svg class="w-8 h-8 md:w-10 md:h-10" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20"/><path d="m17 5-5-3-5 3"/><path d="m17 19-5 3-5-3"/><path d="M2 12h20"/><path d="m5 7-3 5 3 5"/><path d="m19 7 3 5-3 5"/></svg>
                    </div>
                ...
                <p class="text-2xl md:text-4xl font-black text-white italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->today_revenue, 0, ',', '.') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-primary-red transition-all group overflow-hidden relative">
                ...
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <div class="p-4 md:p-5 bg-primary-red/10 rounded-2xl text-primary-red">
                        <svg class="w-8 h-8 md:w-10 md:h-10" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/></svg>
                    </div>
                ...
                <p class="text-2xl md:text-4xl font-black text-primary-red italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->today_profit, 0, ',', '.') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-primary-blue transition-all group overflow-hidden relative">
                <div class="absolute -right-8 -bottom-8 opacity-5 group-hover:scale-110 transition-transform duration-700">
                ...
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <div class="p-4 md:p-5 bg-primary-blue/10 rounded-2xl text-primary-blue">
                        <svg class="w-8 h-8 md:w-10 md:h-10" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>
                    </div>
                ...
                <p class="text-2xl md:text-4xl font-black text-gray-800 dark:text-white italic tracking-tighter">{{ $stats->today_transactions }}</p>
                <div class="mt-4 flex items-center">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-primary-red transition-all group overflow-hidden relative">
                ...
                <p class="text-2xl md:text-4xl font-black text-gray-800 dark:text-white italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->avg_transaction, 0, ',', '.') }}</p>
                <div class="mt-4 flex items-center">
                    <span class="text-[9px] font-black uppercase px-2 py-1 rounded-md bg-gray-100 text-gray-500">
                        Nilai Per Transaksi
                    </span>
    ...
    <div class="mb-8 md:mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <!-- Pemasukan (Bulan Ini) -->
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-green-500 transition-all group overflow-hidden relative">
                <div class="absolute -right-8 -bottom-8 opacity-5 group-hover:scale-110 transition-transform duration-700">
                ...
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <div class="p-4 md:p-5 bg-green-500/10 rounded-2xl text-green-500">
                        <svg class="w-8 h-8 md:w-10 md:h-10" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="12" x="2" y="6" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/></svg>
                    </div>
                ...
                <p class="text-2xl md:text-4xl font-black text-green-600 dark:text-green-400 italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->monthly_income, 0, ',', '.') }}</p>
                <p class="mt-4 text-[9px] font-bold text-gray-400 uppercase tracking-widest">Akumulasi Kas Masuk</p>
            </div>

            <!-- Pengeluaran (Bulan Ini) -->
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-red-500 transition-all group overflow-hidden relative">
                <div class="absolute -right-8 -bottom-8 opacity-5 group-hover:scale-110 transition-transform duration-700">
                ...
                <h3 class="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-1">Bulan Ini</h3>
                <p class="text-2xl md:text-4xl font-black text-red-600 dark:text-red-400 italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->monthly_expense, 0, ',', '.') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-green-500 transition-all group overflow-hidden relative">
                ...
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <div class="p-4 md:p-5 bg-green-500/10 rounded-2xl text-green-500">
                        <svg class="w-8 h-8 md:w-10 md:h-10" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M11 15h2a2 2 0 1 0 0-4h-2a2 2 0 1 1 0-4h2"/><path d="M12 17V5"/></svg>
                    </div>
                ...
                <p class="text-2xl md:text-4xl font-black text-gray-800 dark:text-white italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->total_all_time_profit, 0, ',', '.') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-primary-blue transition-all group overflow-hidden relative">
                ...
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <div class="p-4 md:p-5 bg-primary-blue/10 rounded-2xl text-primary-blue">
                        <svg class="w-8 h-8 md:w-10 md:h-10" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h7"/><path d="m16 19 2 2 4-4"/></svg>
                    </div>
                    <span class="text-[10px] font-black uppercase tracking-widest text-primary-blue bg-primary-blue/5 px-4 py-2 rounded-full">Kas Terverifikasi</span>
                </div>
                <h3 class="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-1">Kas Terverifikasi</h3>
                <p class="text-2xl md:text-4xl font-black text-gray-800 dark:text-white italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->total_audit_cash, 0, ',', '.') }}</p>
                <p class="mt-4 text-[9px] font-bold text-gray-400 uppercase tracking-widest">Total Uang Fisik Terkumpul</p>
            </div>

            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-orange-500 transition-all group overflow-hidden relative">
                <div class="absolute -right-8 -bottom-8 opacity-5 group-hover:scale-110 transition-transform duration-700">
                ...
                <p class="text-2xl md:text-4xl font-black text-gray-800 dark:text-white italic tracking-tighter">{{ $stats->total_all_time_transactions }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-primary-red transition-all group overflow-hidden relative">
                ...
                <p class="text-2xl md:text-4xl font-black text-gray-800 dark:text-white italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->total_outstanding_debt, 0, ',', '.') }}</p>
                <p class="mt-4 text-[9px] font-bold text-gray-400 uppercase tracking-widest">Total Tagihan Piutang</p>
            </div>

            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-amber-500 transition-all group overflow-hidden relative">
                <div class="absolute -right-8 -bottom-8 opacity-5 group-hover:scale-110 transition-transform duration-700">
                ...
                <h3 class="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-1">Tiket Rata-rata</h3>
                <p class="text-2xl md:text-4xl font-black text-gray-800 dark:text-white italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->avg_all_time_ticket, 0, ',', '.') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-indigo-500 transition-all group overflow-hidden relative">
                <div class="absolute -right-8 -bottom-8 opacity-5 group-hover:scale-110 transition-transform duration-700">
                ...
                <h3 class="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-1">Seluruh Waktu</h3>
                <p class="text-2xl md:text-4xl font-black text-gray-800 dark:text-white italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->total_all_time_revenue, 0, ',', '.') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3rem] p-5 md:p-10 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 hover:border-indigo-500 transition-all group overflow-hidden relative">
                <div class="absolute -right-8 -bottom-8 opacity-5 group-hover:scale-110 transition-transform duration-700">
                    <svg class="w-48 h-48 text-indigo-500" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="12" x="2" y="6" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/></svg>
                </div>
                <div class="flex items-center justify-between mb-6 md:mb-8">
                    <div class="p-4 md:p-5 bg-indigo-500/10 rounded-2xl text-indigo-500">
                        <svg class="w-8 h-8 md:w-10 md:h-10" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="12" x="2" y="6" rx="2"/><circle cx="12" cy="12" r="2"/><path d="M6 12h.01M18 12h.01"/></svg>
                ...
                <h3 class="text-gray-400 text-[10px] font-black uppercase tracking-widest mb-1">Seluruh Waktu</h3>
                <p class="text-2xl md:text-4xl font-black text-indigo-600 dark:text-indigo-400 italic tracking-tighter" :class="censorMode ? 'privacy-blur' : ''">Rp{{ number_format($stats->total_modal_balance, 0, ',', '.') }}</p>
    ...
    <!-- Chart Section -->
    <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3.5rem] p-5 md:p-10 mb-8 md:mb-16 shadow-2xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 overflow-hidden">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 md:mb-10">
            <div>
                <h2 class="text-xl md:text-2xl font-black italic uppercase tracking-tighter text-gray-800 dark:text-white leading-none">Grafik Performa Mingguan</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-12">
        <!-- Recent Transactions -->
        <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3.5rem] shadow-2xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div class="p-5 md:p-10 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                <h2 class="text-xl md:text-2xl font-black italic uppercase tracking-tighter text-gray-800 dark:text-white">Transaksi Terakhir</h2>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    <thead class="bg-gray-50 dark:bg-gray-900/50">
                        <tr>
                            <th class="px-4 md:px-10 py-4 md:py-6 text-[10px] font-black text-gray-400 uppercase tracking-widest">Tanggal</th>
                            <th class="px-4 md:px-10 py-4 md:py-6 text-[10px] font-black text-gray-400 uppercase tracking-widest">Jam</th>
                            <th class="px-4 md:px-10 py-4 md:py-6 text-[10px] font-black text-gray-400 uppercase tracking-widest">Produk</th>
                            <th class="px-4 md:px-10 py-4 md:py-6 text-[10px] font-black text-gray-400 uppercase tracking-widest">Total</th>
                            <th class="px-4 md:px-10 py-4 md:py-6 text-[10px] font-black text-gray-400 uppercase tracking-widest">Status</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/30 transition-colors">
                            ...
                            <td class="px-4 md:px-10 py-4 md:py-8 text-xs font-black text-gray-400">{{ $tx->transacted_at->format('H:i') }}</td>
                            <td class="px-4 md:px-10 py-4 md:py-8">
                                <div class="text-sm md:text-base font-black text-gray-800 dark:text-white uppercase tracking-tight">{{ $tx->product->name }}</div>
                                <div class="text-[10px] font-bold text-gray-400 italic mt-1">Qty: {{ $tx->quantity }}</div>
                            </td>
                            <td class="px-4 md:px-10 py-4 md:py-8 text-base md:text-lg font-black text-primary-red italic">Rp{{ number_format($tx->total_price, 0, ',', '.') }}</td>
                            <td class="px-4 md:px-10 py-4 md:py-8">
                                @php
                                    $statusClasses = [
                                ...
                                @endphp
                                <span class="px-3 py-1 text-[8px] md:text-[9px] font-black rounded-full uppercase tracking-widest {{ $statusClasses[$tx->status] ?? 'bg-gray-100 text-gray-700' }}">
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="px-4 md:px-10 py-16 md:py-32 text-center text-gray-400 font-bold uppercase text-xs tracking-widest italic opacity-20">Belum ada transaksi hari ini</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
        ...
        <!-- Top Products -->
        <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3.5rem] shadow-2xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div class="p-5 md:p-10 border-b border-gray-100 dark:border-gray-700">
                <h2 class="text-xl md:text-2xl font-black italic uppercase tracking-tighter text-gray-800 dark:text-white">Produk Terlaris (All-Time)</h2>
            </div>
            <div class="p-5 md:p-10 space-y-6 md:space-y-10">
                @forelse($topProducts as $top)
                <div class="flex items-center group">
                    <div class="flex-shrink-0 w-12 h-12 md:w-16 md:h-16 bg-primary-blue dark:bg-gray-900 text-white rounded-2xl md:rounded-[1.5rem] flex items-center justify-center font-black italic shadow-2xl shadow-blue-900/10 group-hover:scale-110 transition-transform">
                        {{ $loop->iteration }}
                    </div>
                    <div class="ml-4 md:ml-6 flex-1">
                        <h4 class="text-sm md:text-base font-black text-gray-800 dark:text-white uppercase tracking-tight leading-tight">{{ $top->product->name }}</h4>
                        <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mt-1">{{ $top->total_qty }} Unit Terjual</p>
                    </div>
                    <div class="text-right">
                        <p class="text-base md:text-lg font-black text-primary-red italic">Rp{{ number_format($top->total_revenue, 0, ',', '.') }}</p>
                    </div>
                </div>
                @empty
                <div class="py-16 md:py-32 text-center opacity-20">
                    <svg class="w-16 h-16 md:w-24 md:h-24 mx-auto mb-4 md:mb-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="M12 18v-6"/><path d="m9 15 3 3 3-3"/></svg>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 mt-8 md:mt-12 mb-8 md:mb-16">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3.5rem] shadow-2xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col">
            <div class="p-5 md:p-10 border-b border-gray-100 dark:border-gray-700">
                <h2 class="text-xl md:text-2xl font-black italic uppercase tracking-tighter text-gray-800 dark:text-white">Revenue by Category</h2>
             ...
             <div class="p-5 md:p-10 flex-1 flex flex-col justify-center">
                ...
                <div class="mt-6 md:mt-8 grid grid-cols-2 gap-3 md:gap-4">
                    ...
                    <div class="flex items-center justify-between text-[10px] font-black uppercase tracking-tight bg-gray-50 dark:bg-gray-900/50 p-3 md:p-4 rounded-2xl">
                        <div class="flex items-center">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl md:rounded-[3.5rem] shadow-2xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col">
            <div class="p-5 md:p-10 border-b border-gray-100 dark:border-gray-700">
                <h2 class="text-xl md:text-2xl font-black italic uppercase tracking-tighter text-gray-800 dark:text-white">Monthly Growth</h2>
    ...
    style="display: none;">
        ...
        <div class="bg-white dark:bg-gray-900 w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden border border-gray-100 dark:border-gray-800 transition-all max-h-[90vh] flex flex-col">
            ...
            <div class="p-8 space-y-6 overflow-y-auto no-scrollbar flex-1">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-4 items-start p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-800">
                        ...
                        <div>
                            <h5 class="text-sm font-black text-gray-900 dark:text-white leading-tight">Absen Buka & Stok Awal</h5>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                                Klik tombol <strong>"Buka Kasir"</strong> di dashboard utama. Isi absen masuk Anda, lalu input jumlah <strong>Stok Awal (Opening Stock)</strong> untuk semua produk aktif di toko sebelum memulai pelayanan.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 items-start p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-800">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                                Pilih produk customer di menu instan atau scan barcode. Tentukan kuantitas dan status pelunasan (Lunas, Hutang/Piutang, atau Pending Kembalian), lalu enter untuk mencetak struk belanja.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 items-start p-4 bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-800">
                        ...
                        <div>
                            <h5 class="text-sm font-black text-gray-900 dark:text-white leading-tight">Stok Akhir & Tutup Sesi</h5>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                                Di akhir shift, tekan tombol <strong>"Selesai"</strong> di POS. Masukkan sisa produk fisik (Closing Stock) di rak, hitung uang fisik laci kasir secara manual, dan tulis laporan serah terima.
                            </p>
                        </div>
                    </div>
            ...
            <div class="p-6 bg-gray-50 dark:bg-gray-800 border-t border-gray-100 dark:border-gray-800 flex flex-col sm:flex-row gap-3 justify-end flex-shrink-0">
                <button @click="closeWelcome(false)" class="px-6 py-3.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 text-xs font-black rounded-2xl hover:bg-gray-50 dark:hover:bg-gray-750 transition-all text-center">
                    Langsung Kerja
                </button>
                <button @click="closeWelcome(true)" class="px-8 py-3.5 bg-gradient-to-r from-primary-blue to-blue-600 text-white text-xs font-black rounded-2xl hover:bg-blue-600 shadow-lg shadow-blue-500/25 transition-all text-center">
