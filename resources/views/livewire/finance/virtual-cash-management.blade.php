    ...
    <div class="bg-white dark:bg-gray-800 rounded-[2rem] p-6 shadow-xl shadow-blue-900/5 border border-gray-100 dark:border-gray-700 mb-8 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        <div class="flex flex-wrap items-center gap-4">
            ...
            <div class="flex flex-col">
                ...
                <div class="relative">
                    <select wire:model.live="filterSourceMethod" class="pl-4 pr-10 py-3 bg-gray-50 dark:bg-gray-900 border-none rounded-xl font-black text-xs text-gray-800 dark:text-white uppercase tracking-wider focus:ring-4 focus:ring-primary-blue/10 appearance-none min-w-[150px]">
