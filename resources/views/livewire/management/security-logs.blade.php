<div class="space-y-8 pt-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        @if(session('active_role_name') === 'superadmin')
            <button wire:click="clearLogs" wire:confirm="Apakah Anda yakin ingin menghapus semua log audit keamanan?" class="inline-flex items-center px-5 py-3.5 bg-red-50 hover:bg-red-100 dark:bg-red-950/20 dark:hover:bg-red-900/30 text-primary-red rounded-2xl font-black text-sm uppercase italic tracking-wider transition-all duration-300">
