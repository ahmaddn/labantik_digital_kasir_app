<div class="space-y-8 pt-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold uppercase tracking-tight text-primary-blue dark:text-primary-yellow">Manajemen User</h1>
    ...
    <div x-data="{ showImport: @entangle('showImportModal') }" x-show="showImport" class="fixed inset-0 z-50 flex items-center justify-center p-4" x-cloak>
        ...
        <div x-show="showImport" x-transition.scale class="relative w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-5 border border-gray-100 dark:border-gray-700 z-10">
