<div class="space-y-8 pt-6">
    ...
    <div x-data="{ showCreate: @entangle('showCreateModal') }" x-show="showCreate" class="fixed inset-0 z-50 flex items-center justify-center p-4" x-cloak>
        ...
        <div x-show="showCreate" x-transition.scale class="relative w-full max-w-6xl bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-2xl p-8 border border-gray-100 dark:border-gray-700 z-10 max-h-[90vh] overflow-y-auto">
