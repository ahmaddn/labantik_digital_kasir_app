        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-[2.5rem] shadow-2xl shadow-blue-900/10 p-10 border border-gray-100 dark:border-gray-700">
                ...
                <form method="POST" action="{{ route('login.store') }}" class="space-y-6">
                    ...
                    <button type="submit" class="w-full py-5 bg-primary-blue hover:bg-blue-900 text-primary-yellow rounded-2xl font-black text-lg shadow-xl shadow-blue-900/20 active:scale-95 transition-all uppercase italic tracking-wider">
                        Masuk Sekarang
                    </button>
                </form>
            </div>
