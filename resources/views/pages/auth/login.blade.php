...
>
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        >
            ...
            <div class="absolute -top-32 -left-32 w-80 h-80 lg:w-96 lg:h-96 rounded-full blur-3xl opacity-30 pointer-events-none" style="background-color: #60a5fa;"></div>
            ...
            <div class="absolute top-4 right-4 lg:hidden z-20">
                ...
                >
                    ...
                    <svg x-show="!darkMode" class="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
