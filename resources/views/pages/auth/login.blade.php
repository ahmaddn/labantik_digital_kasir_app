...
>
    <div class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <!-- Kolom KANAN: Form Login (Posisinya tepat di tengah layout vertikal) -->
        <div class="relative flex flex-col justify-between items-center p-6 sm:p-12 lg:p-16 min-h-screen bg-slate-50 dark:bg-slate-900 transition-colors duration-300">
            ...
            <!-- Spacer Atas untuk menjaga alignment -->
            <div class="w-full h-8"></div>

            <!-- Form Wrapper Utama: Ditengah-tengah layar secara Vertikal -->
            <div class="w-full max-w-md my-auto flex flex-col justify-center py-6">
                <!-- Heading -->
                <div class="mb-8">
