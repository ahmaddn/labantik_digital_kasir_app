...
<header class="sticky top-0 z-40 w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-100 dark:border-gray-800 px-8 py-4 flex items-center justify-between shadow-sm">
    ...
    <div class="flex items-center gap-4">
        ...
        @auth
            <div class="hidden sm:flex items-center gap-4 mr-2 bg-gray-50 dark:bg-gray-800/80 px-4 py-2 rounded-2xl border border-gray-100 dark:border-gray-700/50">
                <!-- Streak Badge -->
                ...
                <div class="flex items-center gap-1.5" title="Poin Terkumpul Bulan Ini">
                    ...
                    <span class="text-[10px] font-black text-gray-750 dark:text-gray-200 uppercase tracking-wider">
