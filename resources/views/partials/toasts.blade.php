...
>
    <template x-for="msg in messages" :key="msg.id">
        ...
        >
            <!-- Background Accent -->
            <div 
                class="absolute top-0 left-0 w-2.5 h-full opacity-40"
                :class="{
            ...
            <!-- Icon Container -->
            <div 
                class="w-16 h-16 rounded-[1.8rem] flex items-center justify-center text-white shadow-2xl transition-transform group-hover:rotate-12 duration-500 relative overflow-hidden"
                :class="{
            ...
            >
                ...
                <template x-if="msg.type === 'success'">
                    <svg class="w-8 h-8 relative z-10" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                </template>
            ...
            <!-- Close Button -->
            <button @click="msg.show = false; setTimeout(() => remove(msg.id), 500)" class="p-3 bg-gray-50 dark:bg-gray-800 rounded-xl text-gray-400 hover:text-gray-900 dark:hover:text-white transition-all">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
            </button>
